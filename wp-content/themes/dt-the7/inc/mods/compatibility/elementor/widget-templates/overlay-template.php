...
class Overlay_Template extends Abstract_Template {
	...
	public function add_controls() {
		if (
			! class_exists( OverlayModule::class, false )
			||
		...
		$device_hover_visibility_options = [ '' => esc_html__( 'No change', 'the7mk2' ) ] + $hover_visibility_options;
		...
		$this->widget->add_responsive_control(
			...
			[
				...
				'device_args'          => [
					'tablet' => [
						'options' => $device_hover_visibility_options,
					],
					'mobile' => [
						'options' => $device_hover_visibility_options,
					],
				...
				'selectors_dictionary' => [
					'disabled'   => '--overlay-opacity: 0; --overlay-hover-opacity: 0;',
					'always'     => '--overlay-opacity: 1; --overlay-hover-opacity: 1;',
					'hover'      => '--overlay-opacity: 0; --overlay-hover-opacity: 1;',
					'hover-hide' => '--overlay-opacity: 1; --overlay-hover-opacity: 0;',
				],
				'selectors'            => [
					'{{WRAPPER}}' => ' {{VALUE}};',
				],
