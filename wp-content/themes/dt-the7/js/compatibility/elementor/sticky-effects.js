        ...
        methods = {
            ...
            getStickyConfig: function () {
                ...
                if (settings['the7_sticky_scroll_up'] === 'yes') {
                    let stickOffsetSettings = elementorSettings.getCurrentDeviceSetting('the7_sticky_row_stick_offset');
                    if (stickOffsetSettings !== 'undefined') {
            ...
            scrollIntervalHandler: function (force) {
                if (force) {
                    ...
                    if (st > $widget.vars.scroll.elementHeight) {
    ...
    $(window).on("elementor/frontend/init", function () {
        ...
        function refresh(controlView, widgetView) {
            var reactivateControls = [
                ...
                ...The7ElementorSettings.getResponsiveSettingList('the7_sticky_row_stick_offset'),
