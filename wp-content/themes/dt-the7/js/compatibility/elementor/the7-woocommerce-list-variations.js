    ...
    $.productsVariations = function (el) {
        ...
        methods = {
            init: function () {
                ...
                const $attr = $widget.find(".ajax-variation-enabled .products-variations li a");
                ...
                if (isMobile) {
                    ...
                    const variations_position = widgetSettings.getSettings("variations_position");
                    const button_position = widgetSettings.getSettings("button_position");
                        ...
                        $imgHoverElement.on("touchend", function (e) {
                            ...
                            if (isNotClicked) {
                                ...
                                if (isImageTouch && $(e.target).closest(".products-variations-wrap, .woo-list-buttons", $this).length) {
                                    const isVariationsVisible = (!isVariableProduct || (variations_position && variations_position !== "on_image_hover"));
                                    const isAddToCartVisible = (button_position && button_position !== "on_image_hover");
