...
class MEC_feature_events extends MEC_base
{
    ...
    public function init()
    {
        ...
        {
            $this->factory->action('mec_metabox_details', array($this, 'meta_box_related_events'), 17);
            ...
            {
                $this->factory->action('mec_fes_metabox_details', array($this, 'meta_box_related_events'), 33);
            }
        }
        ...
        if(isset($this->settings['banner_status']) and $this->settings['banner_status'])
        {
            ...
            {
                $this->factory->action('mec_fes_metabox_details', array($this, 'meta_box_banner'), 34);
            }
        }
    ...
    public function meta_box_event_gallery($post)
    {
        ...
        <div id="mec-event-gallery">
            <div id="mec_meta_box_event_gallery_options">
                <?php if(current_user_can('upload_files')): ?>
                <a href="#" type="button" id="mec_event_gallery_image_uploader"><?php esc_html_e('Add event gallery images', 'modern-events-calendar-lite'); ?></a>
                <?php else: ?>
        ...
        <div id="mec-booking">
            ...
            <div class="mec-booking-tab-content mec-tab-active mec-fes-booking-options" id="mec_meta_box_booking_options">
                ...
                <div class="mec-basvanced-advanced w-hidden">
                    ...
                    if((isset($this->settings['thankyou_page_per_event']) && $this->settings['thankyou_page_per_event']) or ($FES and $fes_booking_typ)){
