                        ...
                        <div id="booking_option" class="mec-options-fields active">
                            ...
                            <div id="mec_booking_container_toggle" class="<?php if((isset($settings['booking_status']) and !$settings['booking_status']) or !isset($settings['booking_status'])) echo 'mec-util-hidden'; ?>">
                                    ...
                                    <div class="mec-form-row">
                                        ...
                                        <div class="mec-col-9">
                                            ...
                                            <div class="box left">
                                                ...
                                                <div class="content"><p><?php esc_attr_e("Specify the date format of the event's date on the booking module.", 'modern-events-calendar-lite'); ?><a href="https://webnus.net/dox/modern-events-calendar/booking-settings/#1-_Date_Options/" target="_blank"><?php esc_html_e('Read More', 'modern-events-calendar-lite'); ?></a></p></div>
                                            </div>
                                    ...
                                    <div class="mec-form-row">
                                        ...
                                        <div class="mec-col-9">
                                            ...
                                            <div class="box left">
                                                ...
                                                <div class="content"><p><?php esc_attr_e("Specify the number of dates available in the date selection dropdown menu for recurring events.", 'modern-events-calendar-lite'); ?><a href="https://webnus.net/dox/modern-events-calendar/booking-settings/#1-_Date_Options/" target="_blank"><?php esc_html_e('Read More', 'modern-events-calendar-lite'); ?></a></p></div>
                                            </div>
                                            <i title="" class="dashicons-before dashicons-editor-help"></i>
                                        </span>
                                        </div>
                                    ...
                                    <div class="mec-form-row">
                                        ...
                                        <div class="mec-col-9">
                                            ...
                                            <div class="box left">
                                                ...
                                                <div class="content"><p><?php esc_attr_e("Specify the type of date selection field in the booking module.", 'modern-events-calendar-lite'); ?><a href="https://webnus.net/dox/modern-events-calendar/booking-settings/#2-_Date_Selection_Options/" target="_blank"><?php esc_html_e('Read More', 'modern-events-calendar-lite'); ?></a></p></div>
                                            </div>
                                            <i title="" class="dashicons-before dashicons-editor-help"></i>
                                        </span>
                                        </div>
                                    ...
                                    <div class="mec-form-row">
                                        ...
                                        <div class="mec-col-9">
                                            ...
                                            <div class="box left">
                                                ...
                                                <div class="content"><p><?php esc_attr_e("If enabled, you can change the date selection method per event.", 'modern-events-calendar-lite'); ?></p></div>
                                            </div>
                                            <i title="" class="dashicons-before dashicons-editor-help"></i>
                                        </span>
                                        </div>
                                ...
                                <div class="mec-basvanced-advanced w-hidden">
                                    ...
                                    <div class="mec-form-row">
                                        <label>
                                            ...
                                            <input value="1" type="checkbox" name="mec[settings][last_few_tickets_percentage_per_event]" <?php if(isset($settings['last_few_tickets_percentage_per_event']) and $settings['last_few_tickets_percentage_per_event']) echo 'checked="checked"'; ?> /><?php esc_html_e('Ability to change last few tickets percentage per event', 'modern-events-calendar-lite'); ?>
                                        </label>
                                    </div>
                                        ...
                                        <div class="mec-col-9">
                                            ...
                                            <span class="mec-tooltip">
                                                <div class="box left">
                                                    ...
                                                    <div class="content"><p><?php esc_attr_e("Specify the amount of delay before being redirected to the thank you page. (in milliseconds)", 'modern-events-calendar-lite'); ?><a href="https://webnus.net/dox/modern-events-calendar/booking-settings/#3-_Thank_You_Page/" target="_blank"><?php esc_html_e('Read More', 'modern-events-calendar-lite'); ?></a></p></div>
                                                </div>
                                                <i title="" class="dashicons-before dashicons-editor-help"></i>
                                            </span>
                                        </div>
                                    ...
                                    <div class="mec-form-row">
                                        <label>
                                            ...
                                            <input value="1" type="checkbox" name="mec[settings][thankyou_page_per_event]" <?php if(isset($settings['thankyou_page_per_event']) and $settings['thankyou_page_per_event']) echo 'checked="checked"'; ?> /><?php esc_html_e('Ability to change thank you page per event', 'modern-events-calendar-lite'); ?>
                                        </label>
                                    </div>
                                        ...
                                        <div class="mec-col-9">
                                            ...
                                            <span class="mec-tooltip">
                                                <div class="box left">
                                                    ...
                                                    <div class="content"><p><?php esc_attr_e("Specify the amount of delay before being redirected to the cancellation page. (in milliseconds)", 'modern-events-calendar-lite'); ?><a href="https://webnus.net/dox/modern-events-calendar/booking-settings/#8-_Booking_Cancellation/" target="_blank"><?php esc_html_e('Read More', 'modern-events-calendar-lite'); ?></a></p></div>
                                                </div>
                                                <i title="" class="dashicons-before dashicons-editor-help"></i>
                                            </span>
                                        </div>
                                ...
                                <div class="mec-basvanced-advanced w-hidden">
                                    ...
                                    <h5 class="mec-form-subtitle"><?php esc_html_e('Upload Field', 'modern-events-calendar-lite'); ?></h5>
                                    <div class="mec-form-row">
                                    ...
                                    <h5 class="mec-form-subtitle"><?php esc_html_e('Partial Payment', 'modern-events-calendar-lite'); ?></h5>
                                    <div class="mec-form-row">
                                        <div class="mec-col-12">
                                            <label>
                                            ...
                                            <span class="mec-tooltip">
                                                <div class="box">
                                                    ...
                                                    <div class="content"><p><?php esc_attr_e("You can accept a partial of payment upon booking and manage the rest of payment on your own. For example receive 20% of booking amount online and manage the rest in cash or other payment systems.", 'modern-events-calendar-lite'); ?><a href="https://webnus.net/dox/modern-events-calendar/booking-settings/#9-_Partial_Payment/" target="_blank"><?php esc_html_e('Read More', 'modern-events-calendar-lite'); ?></a></p></div>
                                                </div>
                                                <i title="" class="dashicons-before dashicons-editor-help"></i>
                                            </span>
                                        </div>
                                    ...
                                    <h5 class="mec-form-subtitle"><?php esc_html_e('Discount Per User Roles', 'modern-events-calendar-lite'); ?></h5>
                                    <div class="mec-form-row">
                                        <div class="mec-col-12">
                                            <label>
                                                <input type="hidden" name="mec[settings][discount_per_user_role_status]" value="0" />
                                                <input id="mec_booking_discount_per_user_role_status" value="1" type="checkbox" name="mec[settings][discount_per_user_role_status]" <?php if(isset($settings['discount_per_user_role_status']) and $settings['discount_per_user_role_status']) echo 'checked="checked"'; ?> /><?php esc_html_e('Discount per User Role', 'modern-events-calendar-lite'); ?>
                                            </label>
                                            <span class="mec-tooltip">
                                                <div class="box">
                                                    <h5 class="title"><?php esc_html_e('Discount per User Role', 'modern-events-calendar-lite'); ?></h5>
                                                    <div class="content"><p><?php esc_attr_e("If enabled, you can set discount for users based on their roles.", 'modern-events-calendar-lite'); ?></p></div>
                                                </div>
                                                <i title="" class="dashicons-before dashicons-editor-help"></i>
                                            </span>
                                        </div>
                            ...
                            <div id="mec_taxes_fees_container_toggle" class="<?php if((isset($settings['taxes_fees_status']) and !$settings['taxes_fees_status']) or !isset($settings['taxes_fees_status'])) echo 'mec-util-hidden'; ?>">
                                ...
                                <div class="mec-util-hidden" id="mec_new_fee_raw">
                                    <div class="mec-box" id="mec_fee_row:i:">
                                        ...
                                        <div class="mec-form-row">
                                            <span class="mec-col-4">
                                                <input type="text" name="mec[settings][fees][:i:][amount]" placeholder="<?php esc_attr_e('Amount', 'modern-events-calendar-lite'); ?>" value="0" />
                                                <span class="mec-tooltip">
                                                    <div class="box top">
                                                        <h5 class="title"><?php esc_html_e('Amount', 'modern-events-calendar-lite'); ?></h5>
                                                        <div class="content"><p><?php esc_attr_e("Fee amount, considered as fixed amount if you set the type to amount otherwise considered as percentage", 'modern-events-calendar-lite'); ?><a href="https://webnus.net/dox/modern-events-calendar/booking-settings/#Taxes_Fees/" target="_blank"><?php esc_html_e('Read More', 'modern-events-calendar-lite'); ?></a></p></div>
                                                    ...
                                                    <span class="mec-col-4">
                                                        ...
                                                        <span class="mec-tooltip">
                                                            <div class="box top">
                                                                ...
                                                                <div class="content"><p><?php esc_attr_e("Option Price", 'modern-events-calendar-lite'); ?><a href="https://webnus.net/dox/modern-events-calendar/booking-settings/#Ticket_Variations_per_Ticket/" target="_blank"><?php esc_html_e('Read More', 'modern-events-calendar-lite'); ?></a></p></div>
                                                            </div>
                                                            <i title="" class="dashicons-before dashicons-editor-help"></i>
                                                        </span>
                                                    </span>
                                                    <span class="mec-col-4">
                                                        ...
                                                        <span class="mec-tooltip">
                                                            <div class="box top">
                                                                ...
                                                                <div class="content"><p><?php esc_attr_e("Maximum Per Ticket. Leave blank for unlimited.", 'modern-events-calendar-lite'); ?><a href="https://webnus.net/dox/modern-events-calendar/booking-settings/#Ticket_Variations_per_Ticket/" target="_blank"><?php esc_html_e('Read More', 'modern-events-calendar-lite'); ?></a></p></div>
                                                            </div>
                                                            <i title="" class="dashicons-before dashicons-editor-help"></i>
                                                        </span>
                                                    </span>
                                                    <button class="button mec_remove_ticket_variation_button mec-dash-remove-btn" type="button" id="mec_remove_ticket_variation_button<?php echo esc_attr($i); ?>" onclick="mec_remove_ticket_variation(<?php echo esc_attr($i); ?>, 'ticket_variation');"><?php esc_html_e('Remove', 'modern-events-calendar-lite'); ?></button>
                                                </div>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                                    ...
                                    <div class="mec-util-hidden" id="mec_new_ticket_variation_raw">
                                        <div class="mec-box mec_ticket_variation_row" id="mec_ticket_variation_row:i:">
                                            ...
                                            <div class="mec-form-row">
                                                ...
                                                <button class="button mec_remove_ticket_variation_button mec-dash-remove-btn" type="button" id="mec_remove_ticket_variation_button:i:" onclick="mec_remove_ticket_variation(:i:, 'ticket_variation');"><?php esc_html_e('Remove', 'modern-events-calendar-lite'); ?></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
