...
class FormBuilder extends Singleton {
    ...
    public static function excerpt( $post, $atts = array() ){
        ...
        $placeholder = $required ? __('Event Excerpt', 'modern-events-calendar-lite') : __('Optional Event Excerpt', 'modern-events-calendar-lite');
        ?>
            ...
            <div class="mec-meta-box-fields mec-fes-datetime" id="mec-date-time">
                ...
                <div id="mec_meta_box_date_form">
                    <div class="mec-title">
                        ...
                        <label for="mec_start_date"><?php esc_html_e('Start Date', 'modern-events-calendar-lite'); ?> <?php echo ($required ? '<span class="mec-required">*</span>' : ''); ?></label>
                    </div>
                    <div class="mec-form-row">
                        <div class="mec-col-4">
                    ...
                    <div class="mec-title">
                        <span class="mec-dashicons dashicons dashicons-calendar-alt"></span>
                        <label for="mec_end_date"><?php esc_html_e('End Date', 'modern-events-calendar-lite'); ?> <?php echo ($required ? '<span class="mec-required">*</span>' : ''); ?></label>
                    </div>
                    <div class="mec-form-row">
                        <div class="mec-col-4">
    ...
    public static function event_gallery($post, $atts = array())
    {
        ...
        <div id="mec-event-gallery" class="mec-meta-box-fields mec-fes-gallery">
            ...
            <div id="mec_meta_box_event_gallery_options" class="mec-form-row">
                <?php if(current_user_can('upload_files')): ?>
                <button type="button" id="mec_event_gallery_image_uploader" class="button"><?php esc_html_e('Add event gallery images', 'modern-events-calendar-lite'); ?></button>
                <?php else: ?>
        ...
        <div class="mec-meta-box-fields mec-booking-tab-content mec-fes-attendees" id="mec_meta_box_booking_options_form_attendees">
            ...
            <?php if(count($booking_dates)): ?>
                <?php
                    ...
                    $from = '<select id="mec_move_bookings_booking_dates_dropdown" title="'.esc_attr__('Occurrence', 'modern-events-calendar-lite').'">
                        '.$from_options.'
                    </select>';
                    ...
                    $to = '<select id="mec_move_bookings_occurrences_dropdown" title="'.esc_attr__('Occurrence', 'modern-events-calendar-lite').'">
                        '.$to_options.'
                    </select>';
                ?>
    ...
    public static function tickets( $post, $atts = array() ){
        ...
        $variations_per_ticket_status = (isset($settings['ticket_variations_per_ticket']) and $settings['ticket_variations_per_ticket']);
        ...
        $family_ticket_status = (isset($settings['booking_family_ticket']) and $settings['booking_family_ticket']);
        ?>
        <div class="mec-meta-box-fields mec-booking-tab-content mec-fes-tickets" id="mec-tickets">
                ...
                <div id="mec_tickets">
                    ...
                    foreach($tickets as $key => $ticket)
                    {
                        ...
                        <div class="mec-box mec_ticket_row" id="mec_ticket_row<?php echo esc_attr($key); ?>">
                            ...
                            <div class="mec-form-row wn-ticket-time mec-basvanced-advanced w-hidden">
                            ...
                            <div id="mec_price_per_dates_container" class="mec-basvanced-advanced w-hidden">
                                <div class="mec-form-row">
                            ...
                            <?php
                                ...
                                $TicketVariations = \MEC\Base::get_main()->getTicketVariations();
                            ?>
                            <div id="mec_variations_per_ticket_container" class="mec-basvanced-advanced w-hidden">
                                <div class="mec-form-row">
            ...
            <div class="mec-util-hidden" id="mec_new_ticket_raw">
                <div class="mec-box mec_ticket_row" id="mec_ticket_row:i:">
                    ...
                    <?php endif; ?>
                    <div class="mec-form-row mec-basvanced-basic">
                        <textarea class="mec-col-11" type="text" name="mec[tickets][:i:][description]"
                               placeholder="<?php esc_attr_e('Description', 'modern-events-calendar-lite'); ?>"></textarea>
                    </div>
                    <?php if($private_description_status): ?>
                    <div class="mec-form-row mec-basvanced-advanced w-hidden">
                        <textarea type="text" class="mec-col-11" name="mec[tickets][:i:][private_description]"
                    ...
                    <div id="mec_price_per_dates_container_:i:" class="mec-basvanced-advanced w-hidden">
                        <div class="mec-form-row">
                            <h4><?php esc_html_e('Price per Date', 'modern-events-calendar-lite'); ?></h4>
                            <button class="button mec_add_price_date_button" type="button"
                            ...
                            <div id="mec_ticket_price_raw_:i:_:j:">
                                <div class="mec-form-row">
                                    ...
                                    <input class="mec-col-3" type="number" name="mec[tickets][:i:][dates][:j:][price]"
                                           placeholder="<?php esc_attr_e('Price', 'modern-events-calendar-lite'); ?>" min="0" step="0.01"/>
                                    <input class="mec-col-3" type="text" name="mec[tickets][:i:][dates][:j:][label]"
                                           placeholder="<?php esc_attr_e('Label', 'modern-events-calendar-lite'); ?>"/>
                                    <button class="button mec_ticket_price_remove_button mec-dash-remove-btn" type="button"
    ...
    public static function recaptcha( $post, $atts = array() ){
        ...
        $is_edit_mode = $atts['is_edit_mode'] ?? false;
        $status = \MEC\Base::get_main()->getCaptcha()->status('fes');
        ...
        if($status) echo \MEC\Base::get_main()->getCaptcha()->field();
    }
