		...
		foreach( $fees as $key => $fee ) {
			...
			switch( $type ) {
				case 'amount_per_date':
					...
					$fee_amount = $fee_amount_config * $total_tickets_dates;
					$fee_amount = $fee_amount / $total_tickets_count;
					break;
				case 'percent': // per ticket

					$fee_amount = ( $tickets_and_variations_amount_with_discount * $fee_amount_config ) / 100;
					break;
				case 'amount': // per ticket

					$fee_amount = $tickets_count * $fee_amount_config;
					break;
