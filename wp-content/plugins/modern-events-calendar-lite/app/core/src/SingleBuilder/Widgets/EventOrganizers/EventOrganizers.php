		...
		if ( true === $this->is_editor_mode && ( empty($organizers) || !isset($organizers[$primary_organizer_id]) ) ) {
			...
			echo '<div class="mec-event-meta">';
				...
				<div class="mec-single-event-organizer">
					...
					<?php endif; ?>
					<h3 class="mec-events-single-section-title"><a href="<?php echo home_url().'/mec-organizer-details-single-page/?fesection=organizer&feparam='.$organizer['id']; ?>"><?php echo Base::get_main()->m('taxonomy_organizer', esc_html__('Organizer', 'modern-events-calendar-lite')); ?></a></h3>
