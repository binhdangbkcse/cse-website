		...
		if ( true === $this->is_editor_mode && ( empty($locations) || !isset($locations[$primary_location_id]) ) ) {
			...
			echo '<div class="mec-event-meta">';
				...
				<div class="mec-single-event-location">
					...
					<h3 class="mec-events-single-section-title mec-location"><a href="<?php echo home_url().'/mec-location-details-single-page/?fesection=location&feparam='.$location['id']; ?>"><?php echo Base::get_main()->m('taxonomy_location', esc_html__('Location', 'modern-events-calendar-lite')); ?></a></h3>
