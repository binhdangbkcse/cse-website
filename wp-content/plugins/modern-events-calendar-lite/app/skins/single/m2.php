            ...
            <div class="mec-event-meta mec-color-before mec-frontbox <?php echo ((!$this->main->can_show_booking_module($event) and in_array($organizer_id, array('0', '1')) and !$more_info) ? 'mec-util-hidden' : ''); ?>">
                ...
                if($organizer_id and count($organizer))
                {
                    ...
                    <div class="mec-single-event-organizer">
                        ...
                        <?php endif; ?>
                        <h3 class="mec-events-single-section-title"><a href="<?php echo home_url().'/mec-organizer-details-single-page/?fesection=organizer&feparam='.$organizer['id']; ?>"><?php echo esc_html($this->main->m('taxonomy_organizer', esc_html__('Organizer', 'modern-events-calendar-lite'))); ?></a></h3>
                        <dl>
            ...
            <div class="mec-event-meta mec-color-before mec-frontbox">
                ...
                if(count($location))
                {
                    ...
                    <div class="mec-single-event-location">
                        ...
                        <h3 class="mec-events-single-section-title mec-location"><a href="<?php echo home_url().'/mec-location-details-single-page/?fesection=location&feparam='.$location['id']; ?>"><?php echo esc_html($this->main->m('taxonomy_location', esc_html__('Location', 'modern-events-calendar-lite'))); ?></a></h3>
                        <dl>
